      ...
      <div className="flex gap-2 items-center">
        {supported && (
          <button
            ...
            className={`flex-shrink-0 h-[48px] w-[48px] rounded-xl flex items-center justify-center transition-colors ${
              listening
